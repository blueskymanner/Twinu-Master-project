...
"
                        ...
                        <List>
                            <ListItem>
                                <ListItemText
                                    children={
                                        <span>
                                            <Code inline>yarn build</Code>: if
                                            you need just to build the app
                        ...
                        <Typography variant={'body2'}>
                            For more instruction please refer to $TWITTERINU |
                            Twitter Inu DApp readme.md.
                        </Typography>
                    </Widget>
                </Grid>
            </Grid>

                ...
                <Grid item xs={12}>
                    <Widget disableWidgetMenu>
                        <Typography variant={'h6'}>
                            $TWITTERINU | Twitter Inu Dapp is an admin dashboard
                            template built with React 16.8.6. Sing App goes
                            beyond usual admin templates and provides you entire
                            intuitive programming framework. You can use
                            $TWITTERINU | Twitter Inu Dapp to build any type of
                            web applications like SAAS, CMS, financial
                        ...
                        <Box pt={6} pb={6}>
                            ...
                            <Typography variant={'p'}>
                                <p className="lead">
                                    ...
                                    our support forum and raise your questions
                                    or feedback provide there. We highly
                        ...
                        >
                            <Box>
                                ...
                                <Link
                                    href={
                                        '#/documentation/getting-started/licences'
                                    }
                                    variant={'h6'}
                                    color={'primary'}
                                    className={styles.link}
